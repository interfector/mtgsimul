...
std::vector<std::pair<MTGCard*,int>> libraryQuantity = {
	std::pair<MTGCard*,int>(new MTGCard("Expedition Map", "1", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Lotus Petal", "0", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Elvish Spirit Guide", "0", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Pithing Needle", "1", 0) , 3),	
	std::pair<MTGCard*,int>(new MTGCard("Vampire Hexmage", "BB", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Crop Rotation", "G", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Not of This World", "7", 0) , 3),	
	std::pair<MTGCard*,int>(new MTGCard("Blooming Marsh", "0", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Dark Depths", "0", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Gemstone Mine", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Ghost Quarter", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Llanowar Wastes", "0", 0) , 2),	
	std::pair<MTGCard*,int>(new MTGCard("Maze of Ith", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Sejiri Steppe", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Snow-Covered Forest", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Snow-Covered Swamp", "0", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Thespian's Stage", "0", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Urborg, Tomb of Yawgmoth", "0", 0) , 3),	
	std::pair<MTGCard*,int>(new MTGCard("Duress", "B", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Inquisition of Kozilek", "B", 0) , 4),	
	std::pair<MTGCard*,int>(new MTGCard("Into the North", "1G", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Living Wish", "1G", 0) , 1),	
	std::pair<MTGCard*,int>(new MTGCard("Sylvan Scrying", "1G", 0) , 4),	
};
